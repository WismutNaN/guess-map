...
fn seed_data(conn: &rusqlite::Connection) {
    ...
    match seed::country_domain::seed(conn) {
        Ok(n) if n > 0 => eprintln!("Seeded {} country_domain hints", n),
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::asset::list_assets_for_editor,
            commands::asset::list_asset_usage,
            commands::asset::replace_asset_bytes,
            commands::asset::crop_asset_image,
